...
const CareersValues: React.FC = () => {
    return (
        <section className="container mx-auto px-4 pt-4 md:pt-6 pb-8 md:pb-12">

            {/* Mission Driven Team Intro */}
            <div className="w-full max-w-[841px] mx-auto mb-20 md:mb-40">
            ...
            <div className="w-full max-w-[841px] mx-auto mb-8">
