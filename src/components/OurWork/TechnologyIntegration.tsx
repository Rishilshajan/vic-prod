    ...
    return (
        <section className="w-full pt-4 pb-12 md:pt-8 md:pb-20 bg-white">
            <div className="container mx-auto px-4">
                ...
                <div
                    className="relative w-11/12 lg:w-full max-w-[1246px] mx-auto rounded-[20px] flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-0 mt-6 lg:mt-0 h-auto lg:h-[562px]"
                    style={{
                ...
                >
                    ...
                    <div
                        className="flex-1 w-full lg:min-w-[487px] lg:max-w-[487px] p-8 md:p-12 border-[3px] border-[#0C87BE] z-20 font-poppins rounded-[20px] bg-white h-auto lg:h-[598px]"
                    >
                    ...
                    {/* Center Column: Icons */}
                    {/* Visible on mobile (flex-row) and desktop (flex-col) */}
                    <div
                        className="flex lg:flex-col flex-row justify-between items-center py-4 lg:py-12 px-0 lg:px-6 relative z-10 w-full lg:w-[272px] lg:self-stretch overflow-hidden rounded-[20px] lg:rounded-none mx-auto lg:mx-0"
                        style={{
                    ...
                    >
                        <div className="flex-1 flex lg:flex-col flex-row justify-between items-center h-full w-full gap-4 lg:gap-8">

                            {/* Icon 1: Line Chart */}
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="transform scale-75 md:scale-100">
                            ...
                            {/* Icon 2: Shield/Check */}
                            <svg width="40" height="40" viewBox="0 90 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="transform scale-75 md:scale-100">
                            ...
                            {/* Icon 3: Zap/Doc */}
                            <svg width="40" height="40" viewBox="0 180 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="transform scale-75 md:scale-100">
                            ...
                            {/* Icon 4: Pie/Time */}
                            <svg width="40" height="40" viewBox="0 270 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="transform scale-75 md:scale-100">
                            ...
                            {/* Icon 5: Layers */}
                            <svg width="40" height="40" viewBox="0 360 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="transform scale-75 md:scale-100">
                    ...
                    <div
                        className="flex-1 w-full lg:min-w-[487px] lg:max-w-[487px] p-8 md:p-12 border-[3px] border-[#228B22] z-20 font-poppins rounded-[20px] bg-white h-auto lg:h-[598px]"
                    >
