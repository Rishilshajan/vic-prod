      ...
      <div className="relative mt-[25px] md:mt-[40px] group w-full md:w-auto h-[350px] md:h-auto flex justify-center md:block">
        ...
        <picture>
          ...
          <img
            ...
            alt="Team Strategy"
            className="absolute md:static left-[-40px] md:left-auto top-0 md:top-auto w-[437px] md:w-[1297px] h-[350px] md:h-[618.5px] max-w-none md:max-w-[95vw] object-cover md:object-contain rounded-[58px] md:rounded-none"
          />
        </picture>
